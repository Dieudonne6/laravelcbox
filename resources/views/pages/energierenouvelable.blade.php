...
<section class="section-box">
    <div class="banner-hero banner-breadcrums">
      <div class="container text-center">
        <h1 class="text-heading-2 color-gray-1000 mb-20" _msttexthash="160706" _msthash="36">Energie renouvelable</h1>
      </div>
    </div>
</section>
...
<section class="section-box mt-100">
  ...
  <div class="section-box mt-100"></div>
  <div class="container">
    <div class="row">
      <div class="col-lg-12 col-sm-12 col-12">
        <ul class="list-icons-2">
          <li>
            <h3 class="text-heading-5 mb-10">Quelle est l’énergie renouvelable la moins chère ?</h3>
            <p class="text-body-text color-gray-500">L’énergie solaire est devenue de plus en plus abordable ces dernières années, mais il est essentiel de considérer les coûts d’installation et de maintenance.</p>
          </li>
          <li>
          ...
          <li>
            <h3 class="text-heading-5 mb-10">Pourquoi les éoliennes ne peuvent-elles exploiter tous les vents ?</h3>
            <p class="text-body-text color-gray-500">Les éoliennes nécessitent une vitesse minimale du vent pour produire de l’électricité de manière efficace.</p>
          </li>
          <li>
  ...
  <section class="section-box mt-70">
    <div class="container text-center">
      <h3 class="text-heading-1 mb-10">Vous avez encore des questions ?</h3>
      <p class="text-body-lead-large color-gray-600 mt-30">Si vous ne trouvez pas de réponse à votre question dans notre FAQ, vous pouvez toujours <br class="d-lg-block d-none">Contactez-nous. Nous vous répondrons sous peu !</p>
    </div>
