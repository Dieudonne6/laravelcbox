...
<section class="section-box">
  <div class="banner-hero banner-breadcrums">
    <div class="container text-center">
      ...
      <p class="text-body-text color-gray-500">Equidem necessitatibus ei eam, ceteros expetenda<br class="d-lg-block d-none"> hendrerit ei per, tation vituperatoribus ut.</p>
    </div>
  </div>
</section>
<section class="section-box">
  <div class="container  mt-90">
    <div class="row">
      <div class="col-lg-8">
        <h3 class="text-heading-1 mb-10">Latest News</h3>
  ...
  <div class="container mt-90">
    <div class="row">
      <div class="col-lg-4 col-sm-12 pr-30">
        <div class="card-grid-style-4"><a class="text-heading-4" href="blog-single.html">We can blend colors multiple ways, the most common</a>
          <div class="grid-4-img"><a href="blog-single.html"><img src="assets/imgs/page/homepage1/img-news-1.png" alt="Agon"></a></div>
        </div>
      </div>
      <div class="col-lg-4 col-sm-12 pr-30">
        <div class="card-grid-style-4"><a class="text-heading-4" href="blog-single.html">How To Blow Through Capital At An Incredible Rate</a>
          <div class="grid-4-img"><a href="blog-single.html"><img src="assets/imgs/page/homepage1/img-news-2.png" alt="Agon"></a></div>
        </div>
      </div>
      <div class="col-lg-4 col-sm-12 pr-30">
        <div class="card-grid-style-4"><a class="text-heading-4" href="blog-single.html">Design Studios That Everyone Should Know About?</a>
