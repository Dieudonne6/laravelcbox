...
<div class="section-box mt-90">
    <div class="container">
      <h2 class="text-heading-1 color-gray-900">Quel commerce faisons-nous ?</h2>
      <div class="row"></div>
    ...
    <div class="container mt-70">
      <div class="row">
        ...
        <div class="col-xl-4 col-lg-3 col-md-2 col-sm-6 col-12">
          <div class="category-grid-3 hover-up">
            <div class="category-img"><a href="#"><img src="assets/imgs/page/shop1/printer.svg" alt="agon"></a></div>
