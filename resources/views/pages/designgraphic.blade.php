...
<section class="section-box">
    ...
    <div class="container">
      <div class="row justify-content-center align-items-center">
        <div class="col-xl-6 col-lg-6 col-sm-12 block-we-do">
          <h3 class="text-heading-3 mt-20">AUDACIEUX RENCONTRE BRAVE</h3>
          <p class="color-gray-600 mt-30  mb-30 text-body-excerpt"> Si vous êtes assez audacieux pour faire les choses différemment, vous avez besoin d’une agence suffisamment courageuse pour faire de même. Nous avons fondé la CBOX pour apporter une bouffée d’air frais dans un marché animé. Une petite équipe dédiée qui crée un travail honnête pour des clients honnêtes, des startups aux grands noms, à l’échelle mondiale.</p>
          <a class="btn btn-black text-heading-5 icon-arrow-right-white" href="{{url('/contact')}}">Faire une demande</a>
        </div>
        <div class="col-xl-6 col-lg-6 col-sm-12 mb-30"><img class="bdrd-16 img-responsive" src="assets/imgs/template/design.jpg" alt="Agon"></div>
  ...
  <section class="section-box">
    <div class="container mt-30">
      <div class="row justify-content-center align-items-center">
        <div class="col-lg-6 col-sm-12 block-img-we-do"><img class="bdrd-16 img-responsive" src="assets/imgs/template/4.png" alt="Agon"></div>
        <div class="col-lg-6 col-sm-12 block-we-do">
          <h3 class="text-heading-1 mt-30">Une identitée visuelle unique</h3>
