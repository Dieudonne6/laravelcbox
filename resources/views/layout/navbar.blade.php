  ...
  <div class="container">
    <div class="main-header">
      <div class="header-left">
        <div class="header-logo"><a class="d-flex" href="index.html"><img alt="Agon" src="assets/imgs/template/cbox.png"></a></div>
      ...
      <div class="header-right">
        <div class="block-signin"><a class="btn btn-default btn-black hover-up icon-arrow-right-white" href="page-signup.html">Get Started</a></div>
      </div>
    </div>
  </div>
</header>
